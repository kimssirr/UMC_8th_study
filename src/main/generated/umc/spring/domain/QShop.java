...
public class QShop extends EntityPathBase<Shop> {
    ...
    public final ListPath<umc.spring.domain.mapping.ShopCategory, umc.spring.domain.mapping.QShopCategory> shopCategoryList = this.<umc.spring.domain.mapping.ShopCategory, umc.spring.domain.mapping.QShopCategory>createList("shopCategoryList", umc.spring.domain.mapping.ShopCategory.class, umc.spring.domain.mapping.QShopCategory.class, PathInits.DIRECT2);
